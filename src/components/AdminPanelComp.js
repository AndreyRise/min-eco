    ...
    return (<>
      <div className="flex flex-col overflow-auto justify-between">
        ...
        <ul className="px-4 flex flex-2 flex-col justify-self-center">
          <li className="navBarBtn" onClick={()=>{setActionDetect(!actionDetect); navigate('/adminPanel/allReleases')}}>{svg.allReleases}Релизы</li>
          <li className="navBarBtn" onClick={()=>{setActionDetect(!actionDetect); navigate('/adminPanel/allUsers')}}>{svg.allUsers}Пользователи</li>
          <li className="navBarBtn" onClick={()=>{setActionDetect(!actionDetect); navigate('/adminPanel/allWithdrawals')}}>{svg.withdrawals}Заявки на вывод</li>
          <li className="navBarBtn" onClick={()=>{setActionDetect(!actionDetect); navigate('/adminPanel/links')}}>{svg.links}Линки</li>
          <li className="navBarBtn" onClick={()=>{setActionDetect(!actionDetect); navigate('/adminPanel/settigns')}}>{svg.gear}Настройки</li>
